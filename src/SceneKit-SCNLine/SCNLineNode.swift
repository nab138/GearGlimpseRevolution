...
// https://github.com/maxxfrazer/SceneKit-SCNLine/blob/main/Sources/SCNLine/SCNLineNode.swift
...
public class SCNLineNode: SCNNode {
  ...
  public init(
    with points: [SCNVector3] = [], radius: Float = 1, edges: Int = 12, maxTurning: Int = 4
  ) {
    self.points = points
    self.radius = radius
    self.edges = edges
